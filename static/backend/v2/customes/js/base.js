                ...
                $.ajax({
                    ...
                    success: function (result) {
                        if (result.error_code !== 0) {
                            ...
                            if (typeof result.data.user_debit_sum_amount != "undefined") {
                                $(".sum-amount-debit").html($.number(result.data.user_debit_sum_amount) + "<sup>đ</sup>");
                            }
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.error_code == 0) {
                    ...
                    // console.log(result.data.user_debit);
                    // if (result.data.user_debit.amount > 0) {
                    //     $(".block-header-debit").show();
                    //     $(".txt-header-debit").html("Nợ: -" + $.number(result.data.user_debit.amount) + "<sup>đ</sup>");
                    // }
