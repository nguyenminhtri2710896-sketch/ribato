        ...
        */
        _uploadXhr: function (fileObj, url, params, headers, sizeBox, progBar, progBox, pctBox, abortBtn, removeAbort) {
            ...
            if (opts.multipart === true) {
                ...
                if (!hasFile) {
                    // console.log();
                    /**
                     * Kiem tra co yeu cau resize hay khong
                     */

                    if (typeof this._opts.resize_image != "undefined" && fileObj.file.size > 300000) {
                        var image_width = this._opts.resize_image.w;
                        var image = new Image;
                        var canvas = document.createElement("canvas");
                        var context = canvas.getContext("2d");
                        image.onload = function () {
                            const width = image_width; // set your width
                            ...
                            var file = new File([new Uint8Array(array)], 'temp.png', { type: 'image/png' });
                            // var file=new Blob([new Uint8Array(array)], {type: 'image/png'});
                            formData.append(opts.name, file);
                            xhr.send(formData);
                        }
                        image.src = URL.createObjectURL(fileObj.file)
        ...
        _initUpload: function (fileObj) {
            ...
            if (this._opts.authorization) {
                headers['Authorization'] = this._opts.authorization;
            }
