// Lightweight i18n system for RbWallet Privacy Policy
class I18n {
  constructor() {
    this.translations = {};
  ...
  async setLanguage(lang) {
    ...
    localStorage.setItem('privacy-policy-lang', lang);
  }
...
class DarkMode {
  ...
  getStoredTheme() {
    return localStorage.getItem('privacy-policy-theme');
  }
  ...
  setTheme(theme) {
    ...
    localStorage.setItem('privacy-policy-theme', theme);
  }
  ...
  init() {
    ...
    window.matchMedia('(prefers-color-scheme: dark)').addEventListener('change', (e) => {
      ...
      if (!localStorage.getItem('privacy-policy-theme') && !this.getUrlParam('theme')) {
