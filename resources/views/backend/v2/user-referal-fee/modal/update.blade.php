<!--  Large modal example -->
<div class="modal fade bs-modal-update-user-referal-fee" tabindex="-1" role="dialog"
    aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm  modal-custom-sm">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myLargeModalLabel">Cập nhật phí người giới thiệu</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form class="form-horizontal needs-validation frm-ajax-submit" novalidate method="POST"
                    data-ajax-url="{{ route('backend.user-referal-fee.ajax-update') }}"
                    data-reload-datatable="#data-table-user-referal-fee-list">
                            ...
                            <div class="form-group">
                                <div class="has-validation">
                                    ...
                                    <select name="type_id" style="width:100%" class="base-select2  form-control form-control-custom">
                                        @foreach (\App\Services\UserReferalFeeService::$arrTypeId as $intId => $arrTypeId)
