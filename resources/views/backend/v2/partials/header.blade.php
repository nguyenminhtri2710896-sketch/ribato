        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{ route('backend.index.index') }}" class="logo logo-dark">
                    ...
                    {{-- <span class="logo-sm">
                        <img src="{{ asset('backend/v2/images/logo.svg') }}" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('backend/v2/images/logo-dark.png') }}" alt="" height="17">
                    </span> --}}
                </a>
                ...
                <a href="{{ route('backend.index.index') }}" class="logo logo-light">
                    ...
                    {{-- <span class="logo-sm">
                        <img src="{{ asset('backend/v2/images/logo-light.svg') }}" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('backend/v2/images/logo-light.png') }}" alt="" height="19">
                    </span> --}}
                </a>
            </div>
        ...
        <div class="d-flex">
            {{-- <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown"
                    ...
                    <img id="header-lang-img" src="{{ asset('backend/v2/images/flags/us.jpg') }}" alt="Header Language"
                        height="16">
                </button>
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="en">
                        <img src="{{ asset('backend/v2/images/flags/us.jpg') }}" alt="user-image" class="me-1"
                            height="12"> <span class="align-middle">English</span>
                    </a>
                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="sp">
                        <img src="{{ asset('backend/v2/images/flags/spain.jpg') }}" alt="user-image" class="me-1"
                            height="12"> <span class="align-middle">Spanish</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="gr">
                        <img src="{{ asset('backend/v2/images/flags/germany.jpg') }}" alt="user-image" class="me-1"
                            height="12"> <span class="align-middle">German</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="it">
                        <img src="{{ asset('backend/v2/images/flags/italy.jpg') }}" alt="user-image" class="me-1"
                            height="12"> <span class="align-middle">Italian</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="ru">
                        <img src="{{ asset('backend/v2/images/flags/russia.jpg') }}" alt="user-image" class="me-1"
            ...
            {{-- <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                    ...
                    <div data-simplebar style="max-height: 230px;">
                        ...
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="d-flex">
                                <img src="{{ asset('backend/v2/images/users/avatar-3.jpg') }}"
                        ...
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="d-flex">
                                <img src="{{ asset('backend/v2/images/users/avatar-4.jpg') }}"
                                    class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                <div class="flex-grow-1">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    <img class="rounded-circle header-profile-user header-profile-user-avatar"
                        src="{{ asset('backend/v2/images/users/avatar-1.jpg') }}" alt="Header Avatar">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="{{ route('backend.account.index') }}"><i
                        ...
                        <span key="t-profile">Thông tin tài khoản</span></a>
                    <!-- <a class="dropdown-item d-block" href="#"><i
                            class="bx bx-wrench font-size-16 align-middle me-1"></i> <span key="t-settings">Cài
                            đặt</span></a> -->
                    <a class="dropdown-item d-block" href="#"><i class="far fa-bell"></i> Thông
                        báo</span></a>
        ...
        <div class="modal-dialog modal-sm  modal-custom-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myLargeModalLabel">Chuyển tiền</h5>
                    ...
                    <form class="form-horizontal needs-validation frm-ajax-submit" novalidate method="POST"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="has-validation">
                                        <label class="mt-0">Email<span class="text-danger">(*)</span></label>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="has-validation">
                                        <label class="mt-3 mb-0">Số dư cần chuyển<span
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="has-validation">
                                        <label class="mt-3 mb-0">Chi chú</label>
