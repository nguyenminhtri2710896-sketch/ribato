...
@section('javascript')
    <!-- INSET JAVA SCRIPT -->
    <script src="{{ asset('backend/v2/customes/js/bank-account.js') }}?v={{ config('app.asset_version') }}"></script>
...
@section('content')
                        ...
                        <div class="btn-group ajax-select2">
                            ...
                            <div class="dropdown-menu dropdown-menu-md p-3 dropdown-menu-search">
                                <form id="table-filer" autocomplete="off">
                                    <div class="mb-2">
                                        <label class="form-label" for="exampleDropdownFormRefCode">Tên tài khoản</label>
                                        <input type="text" name="bank_account_name" class="form-control"
                                            placeholder="Tên tài khoản">
                                    </div>
                                    <div class="mb-2">
                                        <label class="form-label" for="exampleDropdownFormRefCode">Số tài khoản</label>
                                        <input type="text" name="bank_account_number" class="form-control"
                                            placeholder="Số tài khoản">
                                    </div>
                                    <div class="mb-2">
                                        <label class="form-label" for="exampleDropdownFormRefCode">Ngân hàng</label>
                                    ...
                                    <table id="data-table-list"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center" data-priority="2">Tên chủ khoản</th>
                                                <th class="text-center" data-priority="3">Số tài khoản</th>
                                                <th class="text-center" data-priority="4">Ngân hàng</th>
    ...
    @include('backend.v2.bank-account.modal.add')
    @include('backend.v2.bank-account.modal.update')
@endsection
