        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="form-check form-switch form-switch-md mb-3" dir="ltr">
                    ...
                    <label class="form-check-label" for="SwitchAuthy2factor">Bảo mật 2 lớp (Sử dụng cho đăng nhập và yêu
                        cầu rút tiền)</label>
                </div>
            </div>
            <!-- <div class="col-sm-6">
                    ...
                    <tr>
                        ...
                        <td class="api-token-cell">
                            <div class="api-token-box" data-token="" data-revealed="0">
                                ...
                                <button type="button" class="api-token-btn api-token-toggle" title="Hiện/ẩn token"
                                    aria-label="Hiện/ẩn token">
                                    <i class="mdi mdi-eye-outline"></i>
                                </button>
                                <button type="button" class="api-token-btn api-token-copy" title="Sao chép"
                                    aria-label="Sao chép">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 d-grid mt-1">
                    <a href="#!" data-bs-toggle="modal" data-bs-target=".bs-modal-update-webhook-url"
                        class="btn btn-info waves-effect waves-light btn-block"><i class="fas fa-edit"></i> Cập nhật
                        WebHook
                        URL</a>
                </div>
            </div>
            <!-- <div class="row mt-2">
                <div class="col-12 d-grid">
                    <a href="{{ route('backend.personal-token.index') }}"
                        class="btn btn-primary waves-effect waves-light btn-block"><i class="fas fa-cog"></i> Quản lý
                        Token cá nhân</a>
                </div>
            </div> -->
        </div>
