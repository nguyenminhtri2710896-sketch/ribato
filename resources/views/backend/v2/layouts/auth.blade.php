...
<head>
    ...
    <!-- Bootstrap Css -->
    <link href="{{ asset('backend/v2/css/bootstrap.min.css') }}?v={{ config('app.asset_version') }}"
    ...
    <!-- App Css-->
    <link href="{{ asset('backend/v2/css/app.min.css') }}?v={{ config('app.asset_version') }}" id="app-style"
...
<body>
    ...
    <script src="{{ asset('backend/v2/libs/bootstrap/js/bootstrap.bundle.min.js') }}?v={{ config('app.asset_version') }}">
    </script>
    <script src="{{ asset('backend/v2/libs/metismenu/metisMenu.min.js') }}?v={{ config('app.asset_version') }}"></script>
    <script src="{{ asset('backend/v2/libs/simplebar/simplebar.min.js') }}?v={{ config('app.asset_version') }}"></script>
    ...
    <script src="{{ asset('backend/v2/js/pages/form-validation.init.js') }}?v={{ config('app.asset_version') }}"></script>
    <script src="{{ asset('backend/v2/libs/toastr/build/toastr.min.js') }}?v={{ config('app.asset_version') }}"></script>
