...
@section('javascript')
    <!-- <script
        src="{{ asset('backend/v2/customes/js/gateway-account.js') }}?v={{ config('app.asset_version') }}"></script> -->
    <script
        src="{{ asset('backend/v2/customes/js/gateway-account-transaction.js') }}?v={{ config('app.asset_version').time() }}"></script>
...
@section('content')
    ...
    @include('backend.v2.gateway-account.modal.add-money')
    @include('backend.v2.gateway-account.modal.deduct-money')
@endsection