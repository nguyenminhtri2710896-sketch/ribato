...
@section('javascript')
    <!-- INSET JAVA SCRIPT -->
    <script src="{{ asset('backend/v2/customes/js/user.js') }}?v={{ config('app.asset_version') . time() }}"></script>
    <script src="{{ asset('backend/v2/customes/js/user-fee.js') }}?v={{ config('app.asset_version') . time() }}"></script>
    <script
        src="{{ asset('backend/v2/customes/js/user-referal-fee.js') }}?v={{ config('app.asset_version') . time() }}"></script>
    <script
        src="{{ asset('backend/v2/customes/js/user-virtual-account.js') }}?v={{ config('app.asset_version') . time() }}"></script>
...
@section('content')
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="text-primary p-3 user-image-cover"
                                    style="background-image: url('/static/backend/v2/images/profile-img.png'); background-size: contain; background-repeat: no-repeat; background-position: right;">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="avatar-md profile-user-wid-custom">
                                    <img src="{{ asset('backend/v2/images/users/avatar-1.jpg') }}" alt=""
                                            ...
                                            <table id="data-table-user-virtual-account-list"
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="text-center desktop" data-priority="3">Tình trạng</th>
    ...
    @include('backend.v2.user.modal.update')
    @include('backend.v2.user.modal.add-money')
    @include('backend.v2.user.modal.deduct-money')
    @include('backend.v2.user.modal.change-password')
    @include('backend.v2.user-fee.modal.update')
    @include('backend.v2.user-referal-fee.modal.update')
    @include('backend.v2.user.modal.add-virtual-account')
@endsection