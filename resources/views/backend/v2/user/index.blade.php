...
@section('javascript')
    <!-- INSET JAVA SCRIPT -->
    <script src="{{ asset('backend/v2/customes/js/user.js') }}?v={{ config('app.asset_version') }}"></script>
...
@section('content')
                                    ...
                                    <table id="data-table-list" data-ajax-url="{{ route('backend.user.ajax-get-list') }}"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center" data-priority="4">Số dư chờ duyệt trong ngày</th>
                                                <th class="text-center" data-priority="4">Số dư chờ duyệt N+1</th>
                                                <th class="text-center" data-priority="4">Số dư chờ duyệt N+2</th>
    ...
    @include('backend.v2.user.modal.add')
