...
@section('javascript')
    <!-- INSET JAVA SCRIPT -->
    <script src="{{ asset('backend/v1/customes/js/user-bank-account.js') }}?v={{ config('app.asset_version') }}"></script>
...
@section('content')
    ...
    @include('backend.v1.user-bank-account.modal.add')
    @include('backend.v1.user-bank-account.modal.update')
@endsection
