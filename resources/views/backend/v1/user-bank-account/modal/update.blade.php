<!--  Large modal example -->
<div class="modal fade bs-modal-user-bank-account-update ajax-select2" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal needs-validation frm-ajax-submit" novalidate method="POST"
                    data-ajax-url="{{ route('backend.user-bank-account.ajax-update') }}"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="has-validation">
                                    ...
                                    <select name="bank_account_id" style="width:100%" class="js-data-select2" required=""
