    ...
    <div class="modal-dialog modal-sm  modal-custom-sm">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myLargeModalLabel">{{ __('backend.update_info') }}</h5>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="has-validation">
                                    ...
                                    <input type="text" readonly class="form-control" name="email" placeholder="{{ __('backend.email') }}"
                                        required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <div class="has-validation">
                                    ...
                                    <input type="text" readonly class="form-control" name="phone"
                                        placeholder="{{ __('backend.phone') }}" required>
                                </div>
                            </div>
                        </div>
                    </div>
