        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal needs-validation frm-ajax-submit" novalidate method="POST"
                    data-ajax-url="{{ route('backend.bank-account.ajax-add') }}" data-reload-datatable="#data-table-list">
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="has-validation">
                                    ...
                                    <input type="number" class="form-control" name="sorting" placeholder="{{ __('backend.sort') }}" value="0">
                                </div>
                            </div>
                        </div>
                    </div>
