...
@section('title', __('backend.dashboards'))
@section('style')
    <!-- INSET STYLE SCRIPT -->
...
@section('javascript')
    <!-- INSET JAVA SCRIPT -->
    <script src="{{ asset('backend/v1/customes/js/report.js') }}?v={{ config('app.asset_version') }}"></script>
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <p class="text-muted fw-medium">{{ __('backend.total_transaction_amount_in_day') }}</p>
                    ...
                    <div class="col-md-4">
                        <div class="card mini-stats-wid">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <p class="text-muted fw-medium">{{ __('backend.total_amount_pending') }}</p>
                    ...
                    <div class="col-md-4">
                        <div class="card mini-stats-wid">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <p class="text-muted fw-medium">{{ __('backend.total_transaction_amount') }}</p>
                        ...
                        <div class="col-md-4">
                            <div class="card mini-stats-wid">
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="flex-grow-1">
                                            <p class="text-muted fw-medium">{{ __('backend.total_user_balance') }}</p>
                                    ...
                                    <div class="d-flex">
                                        <div class="flex-grow-1 d-flex flex-wrap align-items-center">
                                            <div style="margin-right: 1.5rem; margin-bottom: 0.5rem;">
                                                <p class="text-muted fw-medium mb-1">{{ __('backend.total_gateway_balance') }}</p>
                                                <h4 class="mb-0 total-gateway-balance">0</h4>
                                            </div>
                                            <div style="margin-bottom: 0.5rem;">
                                                <p class="text-muted fw-medium mb-1 font-size-12">{{ __('backend.total_gateway_pending_balance') ?? 'Số dư tạm giữ' }}</p>
