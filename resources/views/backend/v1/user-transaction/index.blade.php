...
@section('title', __('backend.history_deposit_withdraw'))
@section('style')
    <!-- INSET STYLE SCRIPT -->
    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <div class="page-title-left">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">{{ __('backend.deposit_withdraw_history') }}</li>
                        </ol>
                    </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">{{ __('backend.history_deposit_withdraw') }}</h4>
                                    ...
                                    <table id="data-table-user-transaction-list"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-left" data-priority="3">{{ __('backend.type') }}</th>
                                                <th class="text-left" data-priority="3">{{ __('backend.content') }}</th>
                                                <th class="text-left" data-priority="4">{{ __('backend.amount') }}</th>
                                                <th class="text-center" data-priority="5">{{ __('backend.total_amount') }} </th>
                                                <th class="text-center" data-priority="7">{{ __('backend.created_date') }}</th>
                                            </tr>
                                        </thead>
