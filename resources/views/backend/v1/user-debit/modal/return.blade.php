<!--  Large modal example -->
<div class="modal fade bs-modal-user-debit-return  ajax-select2" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-sm  modal-custom-sm">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myLargeModalLabel">Hoàn công công nợ</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form class="form-horizontal needs-validation frm-ajax-submit" novalidate method="POST"
                    data-ajax-url="{{ route('backend.user-debit.ajax-return') }}"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group mt-2">
                                <div class="has-validation">
                                    <label class="mb-0">Ngày hoàn<span class="text-danger">(*)</span></label>
