...
@section('javascript')
    <!-- INSET JAVA SCRIPT -->
    <script src="{{ asset('mod/v1/customes/js/auth.js') }}?v={{ config('app.asset_version') }}"></script>
                        ...
                        <div class="card-body pt-0">
                            <div class="p-2">
                                <form class="form-horizontal needs-validation frm-ajax-submit" novalidate method="POST"
                                    data-ajax-url="{{ route('mod.auth.ajax-sign-in') }}"
                                    data-redirect-url="{{ route('mod.index.index') }}">
                                    ...
                                    <div class="mb-3 position-relative input-auth" style="display: none;">
                                        ...
                                        <input name="auth_2factor_code" type="text" class="form-control"
                                            id="auth_2factor_code" placeholder="Vui lòng nhập mã">
                                    </div>
