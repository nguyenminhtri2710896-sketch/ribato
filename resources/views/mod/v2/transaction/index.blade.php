...
@section('javascript')
    <!-- INSET JAVA SCRIPT -->
    <script src="{{ asset('mod/v2/customes/js/transaction.js') }}?v={{ config('app.asset_version') }}"></script>
...
@section('content')
                            ...
                            <div class="row">
                                <div class="col-sm-12" data-pattern="priority-columns">
                                    <table id="data-table-list"
                                        data-ajax-url="{{ route('mod.transaction.ajax-get-list') }}"
    ...
    @include('mod.v2.transaction.modal.transaction-qrcode')
    @include('mod.v2.transaction.modal.user-qrcode')
