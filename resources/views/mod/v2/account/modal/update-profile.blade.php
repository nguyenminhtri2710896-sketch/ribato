    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myLargeModalLabel">Cập nhật tài khoản</h5>
            ...
            <div class="modal-body">
                <form class="form-horizontal needs-validation form-account-update-profile frm-ajax-submit" novalidate method="POST"
                    data-ajax-url="{{ route('mod.account.ajax-update-info') }}">
                    <div class="col-sm-12 col-md-12">
                        <div class="form-group row mt-3 mb-1">
                            <label for="example-email-input" class="col-sm-2 col-form-label">Họ &amp;
                                Tên</label>
                            ...
                            <div class="col-sm-5 mb-1">
                                <div class="form-group position-relative">
                                    <div class="input-group has-validation">
                                        <input type="text" class="form-control ps-15 bg-transparent" value=""
                                            name="last_name" placeholder="Teen" required="">
                                        <div class="invalid-tooltip">
                                            Vui lòng nhập tên
                                        </div>
                                    </div>
                    ...
                    <div class="col-sm-12 col-md-12">
                        <div class="form-group row mt-3 mb-1">
                            <label for="example-email-input" class="col-sm-2 col-form-label">Số điện
                                thoại</label>
                            <div class="col-sm-10">
                                <div class="form-group position-relative">
                                    <div class="input-group">
